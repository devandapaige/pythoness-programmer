        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-lg p-6 mb-8 max-w-2xl">
          ...
          <div className="text-white/90 space-y-4 text-left">
            <p>
              ...
              <Link href="/newsletter" className="text-brand-green-accent hover:underline"> newsletter</Link>, and anything else I publish here. No paywalls, no &quot;free tier&quot; that gets worse later—they stay free.
            </p>
            <p>
              I monetize through optional support (tips, wishlist) and paid sessions (Software Psychic: async video, live readings, deep dives). 
