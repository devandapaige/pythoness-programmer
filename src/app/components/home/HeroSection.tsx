...
export default function HeroSection() {
  // Static content from content/home/hero.mdx
  const title = "Crafting Digital Joy";
  const tagline = "Tech Clarified | Empowering Digital Confidence";
  const mainText = "Tech doesn't have to be overwhelming. Together, we'll turn your digital challenges into opportunities for growth, learning, and (yes!) even fun.";
  const subText = "From coaching to coding to crafting, I blend technical expertise with creative problem-solving to help you build a digital presence that feels authentically yours.";
