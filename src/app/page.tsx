      ...
      <section className="py-24 px-4 md:px-6 bg-gradient-to-br from-brand-green-dark via-brand-green-dark/90 to-brand-green-dark text-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <AboutCard
            ...
            pythia="The Pythia were ancient oracles — people came to them at crossroads, looking for guidance inside uncertainty. Their prophecies were often delivered in poetic, symbolic language, not step-by-step instructions. That's the work I take from the name: technology and spirituality are interwoven, and we slow the rush of thought until the knots start to untangle. Tech is full of complexity that gets used to make people feel small. My job is to help you work with those patterns — and to remind you that your brain was never the problem."
            values={{
