            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <p className="text-xl text-black/80 max-w-3xl">
                ...
                <span className="block mt-2">
                  As a recognized expert in TypeScript, React, Node.js, and cloud platforms, I combine technical excellence with a people-first approach. You get solutions that are both powerful and truly usable.
                </span>
              </p>
              <div className="h-px w-12 bg-gradient-to-r from-transparent via-black to-transparent"></div>
            </div>
