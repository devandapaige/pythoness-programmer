...
export const metadata: Metadata = {
  title: 'Mindful Automation: Systems That Work For You | 2025 Y.O.U. Edition',
  ...
  openGraph: {
    ...
    type: 'website',
    url: 'https://www.pythonessprogrammer.com/mindful-automation/2025',
  },
  twitter: {
...
export default function MindfulAutomation2025ArchivePage(): ReactNode {
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-green-dark via-brand-purple-dark to-brand-green-dark">
      <div className="site-gutter max-w-4xl mx-auto">
        <div className="prose prose-lg max-w-none">
          {/* Archive banner */}
          <div className="mb-6 mt-4 bg-brand-green-accent/30 border border-brand-green-accent rounded-lg p-4 text-center">
            <p className="text-white text-sm md:text-base mb-0">
              This is the <strong>2025 Y.O.U. edition</strong>. For the current season, see{' '}
              <Link href="/mindful-automation" className="underline font-semibold hover:text-brand-cream">
                Mindful Automation 2026
              </Link>
              .
            </p>
          </div>
          ...
          <section id="you-framework" className="mb-6 mt-0 bg-white/95 border-2 border-brand-green-accent rounded-3xl p-6 md:p-8 shadow-2xl relative overflow-hidden">
            ...
            <div className="grid gap-6 md:grid-cols-3 mt-0">
              {frameworkPillars.map((pillar, i) => {
                const colorStyles = [
                  { border: 'border-[#ffd52c]', bg: 'bg-[#ffde59]/30', iconBg: '#ffde59', iconBorder: '#ffd52c', letter: 'Y' },
                  { border: 'border-[#ff914d]', bg: 'bg-[#ffbd59]/30', iconBg: '#ffbd59', iconBorder: '#ff914d', letter: 'O' },
                  { border: 'border-[#0cc0df]', bg: 'bg-[#5ce1e6]/30', iconBg: '#5ce1e6', iconBorder: '#0cc0df', letter: 'U' },
                ][i];
          ...
          <div className="mt-12 bg-brand-green-accent/20 text-white text-center py-2 px-4 rounded-lg" role="status" aria-label="Content update status">
            <p className="text-sm">2025 edition · archived May 2026</p>
          </div>
        </div>
      </div>
    </div>
