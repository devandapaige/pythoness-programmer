...
> **Video version:** [Put Your IDE Workbench on GitHub](https://youtu.be/hRqye_TTbpI) (~10–12 min — GitHub Desktop, clone [ide-workbench-starter](https://github.com/devandapaige/ide-workbench-starter), open in Cursor, commit and push)
...
>
  <iframe
    ...
    title="Put Your IDE Workbench on GitHub"
...
[Open on YouTube](https://youtu.be/hRqye_TTbpI) if the embed does not load in your reader.
